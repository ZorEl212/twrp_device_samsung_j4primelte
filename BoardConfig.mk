...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 2453520000
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 295698432
BOARD_SUPER_PARTITION_SIZE := 2749218432h	

BOARD_SUPER_PARTITION_GROUPS := msm_dynpart
BOARD_MSM_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_MSM_DYNPART_PARTITION_LIST := system vendor
